...
define( 'WPILOT_SIGNING_SECRET', 'wpi_s3cr3t_2026' );
...
function wpilot_verify_prompt( $data ) {
    ...
    // Simple integrity check: signature present + core data exists
    return ! empty( $data['identity'] ) && strlen( $data['signature'] ) === 64;
}
