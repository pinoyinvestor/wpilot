...
function wpilot_pwa_install_mu_plugin() {
    ...
    $mu_code .= "    // Manifest.json\n";
    $mu_code .= "    if (isset(\$_GET['wpilot_pwa_manifest'])) {\n";
    ...
    $mu_code .= "        } else {\n";
    $mu_code .= "            // Fallback: build manifest from options\n";
    ...
    $mu_code .= "        exit;\n";
    $mu_code .= "    }\n\n";
    $mu_code .= "    // Service Worker JS\n";
    $mu_code .= "    \$uri = \$_SERVER['REQUEST_URI'] ?? '';\n";
    $mu_code .= "    if (parse_url(\$uri, PHP_URL_PATH) === '/wpilot-sw.js') {\n";
    ...
    $mu_code .= "        exit;\n";
    $mu_code .= "    }\n\n";
    $mu_code .= "    // Icon generation\n";
    $mu_code .= "    if (isset(\$_GET['wpilot_pwa_icon'])) {\n";
    $mu_code .= "        if (function_exists('wpilot_pwa_generate_icon')) {\n";
