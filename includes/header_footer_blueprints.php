...
function wpilot_apply_header_blueprint( $params = [] ) {
    ...
    $mu_php .= "}, 1);\n\n";
    $mu_php .= "// Hide theme default header\n";
    $mu_php .= "add_action('wp_head', function() {\n";
    $mu_php .= "    echo '<style id=\"wpilot-hide-theme-header\">';\n";
    $mu_php .= "    echo 'body header:not(#wpilot-header),\n';\n";
    $mu_php .= "    echo 'body #masthead:not(#wpilot-header),\n';\n";
    $mu_php .= "    echo 'body .site-header:not(#wpilot-header),\n';\n";
    $mu_php .= "    echo 'body #site-header:not(#wpilot-header),\n';\n";
    $mu_php .= "    echo 'body .elementor-location-header,\n';\n";
    $mu_php .= "    echo 'body #et-main-area .et-l--header,\n';\n";
    $mu_php .= "    echo 'body .storefront-primary-navigation,\n';\n";
    $mu_php .= "    echo 'body .storefront-secondary-navigation,\n';\n";
    $mu_php .= "    echo 'body .flavor-header { display: none !important; }';\n";
    $mu_php .= "    echo '</style>';\n";
    $mu_php .= "}, 999999);\n";
...
function wpilot_apply_footer_blueprint( $params = [] ) {
    ...
    $mu_php .= "}, 5);\n\n";
    $mu_php .= "// Hide theme default footer\n";
    $mu_php .= "add_action('wp_head', function() {\n";
    $mu_php .= "    echo '<style id=\"wpilot-hide-theme-footer\">';\n";
    $mu_php .= "    echo 'body footer:not(#wpilot-footer),\n';\n";
    $mu_php .= "    echo 'body #colophon:not(#wpilot-footer),\n';\n";
    $mu_php .= "    echo 'body .site-footer:not(#wpilot-footer),\n';\n";
    $mu_php .= "    echo 'body #site-footer:not(#wpilot-footer),\n';\n";
    $mu_php .= "    echo 'body .elementor-location-footer,\n';\n";
    $mu_php .= "    echo 'body #et-main-area .et-l--footer,\n';\n";
    $mu_php .= "    echo 'body .storefront-footer-bar,\n';\n";
    $mu_php .= "    echo 'body .flavor-footer { display: none !important; }';\n";
    $mu_php .= "    echo '</style>';\n";
    $mu_php .= "}, 999999);\n";
