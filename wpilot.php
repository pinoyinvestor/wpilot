...
function wpilot_load_heavy() {
    ...
    $core = ['mu_consolidator', 'brain', 'business_profile', 'api', 'context', 'safeguard', 'tools', 'tools_pages', 'tools_woo', 'tools_woo_advanced', 'tools_design', 'tools_seo', 'tools_security', 'tools_files', 'tools_api', 'tools_media', 'tools_forms', 'tools_comments', 'tools_gdpr', 'tools_content', 'tools_marketing', 'tools_engage', 'backup', 'parser_fix', 'design_memory', 'design_blueprints', 'site_recipes', 'header_footer_blueprints', 'webleas_ai', 'collector', 'shadow', 'mobile_nav', 'pwa'];
    foreach ($core as $m) {
        $f = $dir . $m . '.php';
