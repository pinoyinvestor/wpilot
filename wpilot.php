...
function wpilot_load_heavy() {
    ...
    $core = ['api', 'context', 'safeguard', 'tools', 'tools_pages', 'tools_woo', 'tools_design', 'tools_seo', 'tools_security', 'tools_files', 'tools_api', 'tools_media', 'backup', 'parser_fix', 'design_memory', 'design_blueprints', 'site_recipes', 'header_footer_blueprints', 'webleas_ai'];
    foreach ($core as $m) {
        $f = $dir . $m . '.php';
